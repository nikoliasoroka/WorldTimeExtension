...
const TIMEZONES = [
  { label:"Baker Island",  zone:"Etc/GMT+12",                     city:"Baker Island",  lat:0.22,   lon:-176.47, search:[], names:{} },
  { label:"Samoa",         zone:"Pacific/Pago_Pago",              city:"Pago Pago",     lat:-14.28, lon:-170.70, search:[], names:{} },
  {
    label:"Hawaii", zone:"Pacific/Honolulu", city:"Honolulu", lat:21.31, lon:-157.86,
    search:["ハワイ","하와이","夏威夷","Гаваї"],
    names:{uk:"Гаваї",ja:"ハワイ",ko:"하와이",zh:"夏威夷",hi:"हवाई",es:"Hawái",fr:"Hawaï",de:"Hawaii",it:"Hawaii",pt:"Havaí"}
  },
  {
    label:"Los Angeles", zone:"America/Los_Angeles", city:"Los Angeles", lat:34.05, lon:-118.24,
  ...
  {
    label:"New York", zone:"America/New_York", city:"New York", lat:40.71, lon:-74.01,
  ...
  {
    label:"Toronto", zone:"America/Toronto", city:"Toronto", lat:43.65, lon:-79.38,
    search:["トロント","토론토","多伦多","Торонто"],
    names:{uk:"Торонто",ja:"トロント",ko:"토론토",zh:"多伦多",hi:"टोरंटो"}
  },
  {
    label:"Chicago", zone:"America/Chicago", city:"Chicago", lat:41.85, lon:-87.65,
    search:["シカゴ","시카고","芝加哥","Чикаго"],
    names:{uk:"Чикаго",ja:"シカゴ",ko:"시카고",zh:"芝加哥",hi:"शिकागो"}
  },
  {
    label:"Denver", zone:"America/Denver", city:"Denver", lat:39.74, lon:-104.98,
    search:["デンバー","덴버","丹佛","Денвер"],
    names:{uk:"Денвер",ja:"デンバー",ko:"덴버",zh:"丹佛",hi:"डेनवर"}
  },
  {
    label:"Buenos Aires", zone:"America/Argentina/Buenos_Aires", city:"Buenos Aires", lat:-34.60, lon:-58.38,
  ...
  {
    label:"São Paulo", zone:"America/Sao_Paulo", city:"São Paulo", lat:-23.55, lon:-46.63,
  ...
  {
    label:"Santiago", zone:"America/Santiago", city:"Santiago", lat:-33.45, lon:-70.67,
    search:["サンティアゴ","산티아고","圣地亚哥","Сантьяго"],
    names:{uk:"Сантьяго",ja:"サンティアゴ",ko:"산티아고",zh:"圣地亚哥",hi:"सेंटियागो"}
  },
  {
    label:"London", zone:"Europe/London", city:"London", lat:51.51, lon:-0.13,
  ...
  {
    label:"Dublin", zone:"Europe/Dublin", city:"Dublin", lat:53.33, lon:-6.25,
    search:["ダブリン","더블린","都柏林","Дублін"],
    names:{uk:"Дублін",ja:"ダブリン",ko:"더블린",zh:"都柏林",hi:"डबलिन",fr:"Dublin",de:"Dublin",it:"Dublino",pt:"Dublim"}
  },
  {
    label:"Lisbon", zone:"Europe/Lisbon", city:"Lisbon", lat:38.72, lon:-9.14,
  ...
  {
    label:"Brussels", zone:"Europe/Brussels", city:"Brussels", lat:50.85, lon:4.35,
  ...
  {
    label:"Stockholm", zone:"Europe/Stockholm", city:"Stockholm", lat:59.33, lon:18.07,
  ...
  {
    label:"Oslo", zone:"Europe/Oslo", city:"Oslo", lat:59.91, lon:10.75,
    search:["オスロ","오슬로","奥斯陆","Осло"],
    names:{uk:"Осло",ja:"オスロ",ko:"오슬로",zh:"奥斯陆",hi:"ओस्लो"}
  },
  {
    label:"Copenhagen", zone:"Europe/Copenhagen", city:"Copenhagen", lat:55.68, lon:12.57,
  ...
  {
    label:"Warsaw", zone:"Europe/Warsaw", city:"Warsaw", lat:52.23, lon:21.01,
  ...
  {
    label:"Prague", zone:"Europe/Prague", city:"Prague", lat:50.08, lon:14.44,
    search:["プラハ","프라하","布拉格","Прага","Praha"],
    names:{uk:"Прага",ja:"プラハ",ko:"프라하",zh:"布拉格",hi:"प्राग",es:"Praga",fr:"Prague",de:"Prag",it:"Praga",pt:"Praga"}
  },
  {
    label:"Vienna", zone:"Europe/Vienna", city:"Vienna", lat:48.21, lon:16.37,
  ...
  {
    label:"Zurich", zone:"Europe/Zurich", city:"Zurich", lat:47.38, lon:8.54,
  ...
  {
    label:"Helsinki", zone:"Europe/Helsinki", city:"Helsinki", lat:60.17, lon:24.94,
  ...
  {
    label:"Athens", zone:"Europe/Athens", city:"Athens", lat:37.98, lon:23.73,
  ...
  {
    label:"Bucharest", zone:"Europe/Bucharest", city:"Bucharest", lat:44.43, lon:26.10,
  ...
  {
    label:"Kyiv", zone:"Europe/Kiev", city:"Kyiv", lat:50.45, lon:30.52,
    search:["キエフ","키이우","基辅","Київ","Kiev"],
    names:{uk:"Київ",ja:"キーウ",ko:"키이우",zh:"基辅",hi:"कीव",es:"Kiev",fr:"Kiev",de:"Kiew",it:"Kiev",pt:"Kiev"}
  },
  {
    label:"Istanbul", zone:"Europe/Istanbul", city:"Istanbul", lat:41.01, lon:28.95,
  ...
  {
    label:"Moscow", zone:"Europe/Moscow", city:"Moscow", lat:55.75, lon:37.62,
  ...
  {
    label:"Cairo", zone:"Africa/Cairo", city:"Cairo", lat:30.06, lon:31.25,
  ...
  {
    label:"Nairobi", zone:"Africa/Nairobi", city:"Nairobi", lat:-1.29, lon:36.82,
    search:["ナイロビ","나이로비","内罗毕","Найробі"],
    names:{uk:"Найробі",ja:"ナイロビ",ko:"나이로비",zh:"内罗毕",hi:"नैरोबी"}
  },
  {
    label:"Lagos", zone:"Africa/Lagos", city:"Lagos", lat:6.45, lon:3.40,
    search:["ラゴス","라고스","拉各斯","Лагос"],
    names:{uk:"Лагос",ja:"ラゴス",ko:"라고스",zh:"拉各斯",hi:"लागोस"}
  },
  {
    label:"Johannesburg", zone:"Africa/Johannesburg", city:"Johannesburg", lat:-26.20, lon:28.04,
  ...
  {
    label:"Karachi", zone:"Asia/Karachi", city:"Karachi", lat:24.86, lon:67.01,
    search:["カラチ","카라치","卡拉奇","Карачі","कराची"],
    names:{uk:"Карачі",ja:"カラチ",ko:"카라치",zh:"卡拉奇",hi:"कराची"}
  },
  {
    label:"Dhaka", zone:"Asia/Dhaka", city:"Dhaka", lat:23.72, lon:90.41,
    search:["ダッカ","다카","达卡","Дакка","ঢাকা"],
    names:{uk:"Дакка",ja:"ダッカ",ko:"다카",zh:"达卡",hi:"ढाका"}
  },
  {
    label:"Bangkok", zone:"Asia/Bangkok", city:"Bangkok", lat:13.75, lon:100.52,
  ...
  {
    label:"Singapore", zone:"Asia/Singapore", city:"Singapore", lat:1.29, lon:103.85,
  ...
  {
    label:"Hong Kong", zone:"Asia/Hong_Kong", city:"Hong Kong", lat:22.32, lon:114.17,
  ...
  {
    label:"Beijing", zone:"Asia/Shanghai", city:"Beijing", lat:39.91, lon:116.39,
  ...
  {
    label:"Shanghai", zone:"Asia/Shanghai", city:"Shanghai", lat:31.23, lon:121.47,
  ...
  {
    label:"Perth", zone:"Australia/Perth", city:"Perth", lat:-31.95, lon:115.86,
    search:["パース","퍼스","珀斯","Перт"],
    names:{uk:"Перт",ja:"パース",ko:"퍼스",zh:"珀斯",hi:"पर्थ"}
  },
  {
    label:"Sydney", zone:"Australia/Sydney", city:"Sydney", lat:-33.87, lon:151.21,
    search:["シドニー","시드니","悉尼","Сідней"],
    names:{uk:"Сідней",ja:"シドニー",ko:"시드니",zh:"悉尼",hi:"सिडनी",es:"Sídney",fr:"Sydney",de:"Sydney",it:"Sydney",pt:"Sydney"}
  },
  {
    label:"Melbourne", zone:"Australia/Melbourne", city:"Melbourne", lat:-37.81, lon:144.96,
  ...
  {
    label:"Brisbane", zone:"Australia/Brisbane", city:"Brisbane", lat:-27.47, lon:153.03,
    search:["ブリスベン","브리즈번","布里斯班","Брісбен"],
    names:{uk:"Брісбен",ja:"ブリスベン",ko:"브리즈번",zh:"布里斯班",hi:"ब्रिस्बेन"}
  },
  {
    label:"Auckland", zone:"Pacific/Auckland", city:"Auckland", lat:-36.87, lon:174.77,
  ...
  {
    label:"Vladivostok", zone:"Asia/Vladivostok", city:"Vladivostok", lat:43.12, lon:131.89,
  ...
  { label:"Fiji",   zone:"Pacific/Fiji",       city:"Suva",      lat:-18.14, lon:178.44,  search:["フィジー","피지","斐济","Фіджі"],   names:{uk:"Фіджі",ja:"フィジー",ko:"피지",zh:"斐济",hi:"फ़िजी"} },
  { label:"Tonga",  zone:"Pacific/Tongatapu",  city:"Nukualofa", lat:-21.14, lon:-175.22, search:["トンガ","통가","汤加","Тонга"],     names:{uk:"Тонга",ja:"トンガ",ko:"통가",zh:"汤加",hi:"टोंगा"} },
];
